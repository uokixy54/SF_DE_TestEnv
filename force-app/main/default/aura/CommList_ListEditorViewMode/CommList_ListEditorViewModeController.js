...
({
  ...
  handleRowAction: function(component, event, helper) {
    ...
    } else if (action.name == 'uploadfiles') {
        component.set('v.isAddPhotoModal', true);
    }
  
  },

  // addPhoto: function(component, event, healper) {
  //   // TODO: Add photo Process
  //   component.set('v.isAddPhotoModal', false);
  // },

  handleUploadPhoto: function(component, event, healper) {
    let uploadPhoto = event.getParam("files");
    component.set('v.isAddPhotoModal', false);
  },
